...
function CheckinBooking() {
  ...
  // when booking data hasn't arrived, booking is undefined. So we need to use useEffect to update state when booking changes.
  // after booking data has arrived, paid state is updated
  useEffect(
    function () {
